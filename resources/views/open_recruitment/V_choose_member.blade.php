        ...
        <div class="d-flex flex-wrap justify-content-evenly" style="width: 100%;">
            ...
            <div class="card mb-3 m-2 border border-primary"
                ...
                <div class="d-flex justify-content-center mt-3">
                    <img src="<?= asset('img/logo/himsi.webp') ?>" class="card-img-top" alt="Dewan Pengurus Cabang"
                        style="object-fit: cover; max-width: 80%; height: auto;">
                </div>
                <div class="card-body">
                    <h5 class="card-title text-center text-primary">Dewan Pengurus Cabang</h5>
                    <h5 class="card-title text-center text-primary">( DPC )</h5>
                </div>
            ...
            <div class="card mb-3 m-2 border border-primary"
                ...
                <div class="card-body">
                    <h5 class="card-title text-center text-danger">Dewan Pimpinan Pusat</h5>
                    <h5 class="card-title text-center text-danger">( DPP )</h5>
                </div>
                <div class="d-flex justify-content-center mb-4">
