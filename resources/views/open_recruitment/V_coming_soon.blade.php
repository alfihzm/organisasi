<x-guest-layout title="Closed">
    ...
    <div class="d-flex justify-content-center align-items-center flex-column text-center" style="height: 86vh">
        <h1 class="title-heading">
            <span style="color: #FFF;"> Coming </span>
            <span class="typed-text text-danger"></span><span class="cursor">&nbsp;</span>
        </h1>

        <div>
            <h3 class="subtitle-heading" style="color: #FFF; font-weight: 400;"> Tunggu Informasi <span
                    style="color: #4b7afc; font-weight: 600;">
                </span>
                <span style="color: #FF4056; font-weight: 400;"> Lebih Lanjut<span style="color: #FFF;">. </span> 💪🏻
                </span>
            </h3>
        </div>
